 ...
 * @author cgcai
 * 
 *         The SVY21 class provides functionality to convert between the SVY21
 *         and Lat/Lon coordinate systems.
 * 
 *         Internally, the class uses the equations specified in the following
 *         web page to perform the conversion.
...
public class SVY21 {
	...
	private static double calcM(double lat) { // M: meridian distance.
		...
		double m = a
				* ((A0 * latR) - (A2 * Math.sin(2 * latR)) + (A4 * Math.sin(4 * latR)) - (A6 * Math.sin(6 * latR)));
		return m;
	}
	 ...
	 * 
	 * This method returns an immutable LatLonCoordiante object that contains two
	 * fields,
	...
	/**
	 * Computes SVY21 Northing and Easting based on a Latitude and Longitude
	 * coordinate.
	 * 
	 * This method returns an immutable SVY21Coordinate object that contains two
	 * fields,
	...
	public static SVY21Coordinate computeSVY21(double lat, double lon) {
		...
		double nTerm3 = w6 / 720 * v * sinLat * cos5Lat
